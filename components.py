...
def render_timer():
    ...
    if st.session_state.timer_running and st.session_state.start_time:
        ...
        st.metric("Time Elapsed", f"{elapsed.seconds // 3600:02d}:{(elapsed.seconds // 60) % 60:02d}:{elapsed.seconds % 60:02d}")
    elif st.session_state.elapsed_time:
        st.metric("Time Elapsed", f"{st.session_state.elapsed_time.seconds // 3600:02d}:{(st.session_state.elapsed_time.seconds // 60) % 60:02d}:{st.session_state.elapsed_time.seconds % 60:02d}")
...
def render_time_entry_form(data_manager):
    ...
    with st.form("time_entry_form"):
        ...
        duration = st.text_input("Duration (HH:MM)", "01:00")
